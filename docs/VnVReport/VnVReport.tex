...
%Commented out old tests that are no longer relevant to the system now that DICOM files are not required input from the user
...
\begin{mdframed}[linewidth=0.5mm]
  \textbf{Test Case Name:} Report and Terms Correctness (FRTC5) \par
  \textbf{Input:} Processed chest X-ray images with known medical conditions. \par
...
This subsection outlines the test cases evaluating the software application for its classification of disease functionalities in detail, along with the testing results. \\

\begin{mdframed}[linewidth=0.5mm]
  \textbf{Test Case Name:} Disease Classification Correctness Performance (FRTC6) \par
  ...
  \textbf{Expected Output:} The AUC for the ROC curves for the classification of diseases based on the expected area under the ROC curves is given in Table 6 in the \href{https://github.com/tusharagg1/chest-x-ray-ai/blob/main/docs/SRS/SRS.pdf}{SRS}. \par
  \textbf{Actual Output:} The expected AUC of each disease classification matches the expected AUC given in Table 6 of the \href{https://github.com/tusharagg1/chest-x-ray-ai/blob/main/docs/SRS/SRS.pdf}{SRS}. \par
  \textbf{Expected and Actual Output Match:} True \par
...
\begin{mdframed}[linewidth=0.5mm]
  \textbf{Test Case Name:} Database Search Functionality (FRTC7) \par
...
\hypertarget{Auth}
This subsection outlines the test cases evaluating the software application for its authorization functionalities alongside the testing results. \\

\begin{mdframed}[linewidth=0.5mm]
  \textbf{Test Case Name:} Correct User Login (FRTC8) \par
